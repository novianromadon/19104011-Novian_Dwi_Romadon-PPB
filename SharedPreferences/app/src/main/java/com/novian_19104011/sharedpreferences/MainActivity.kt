...
import com.novian_19104011.sharedpreferences.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showExistingPreference() {
        ...
        populationView(settingModel)
    }

    private fun populationView(settingModel: SettingModel) {
